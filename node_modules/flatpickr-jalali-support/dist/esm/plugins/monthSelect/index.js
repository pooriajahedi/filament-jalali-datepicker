...
function monthSelectPlugin(pluginConfig) {
    ...
    return function (fp) {
        ...
        function buildMonths() {
            ...
            for (var i = 0; i < 12; i++) {
                var month = fp.createDay("flatpickr-monthSelect-month", new fp.l10n.date(fp.currentYear, i), 0, i);
                if (month.dateObj.getMonth() === new fp.l10n.date().getMonth() &&
        ...
        function setMonth(date) {
            var selectedDate = new fp.l10n.date(fp.currentYear, date.getMonth(), date.getDate());
            var selectedDates = [];
